...
public class DiceGenomeEquivalenceTest {
	...
	public void equivalentSameNumbers() throws Exception {
		DiceGenome g1 = new DiceGenome(DiceGenomeTest.NORMAL);
		DiceGenome g2 = new DiceGenome(DiceGenomeTest.NORMAL);
	...
	public void equivalentDifferentNumbers() throws Exception {
		DiceGenome g1 = new DiceGenome(DiceGenomeTest.NORMAL);
		DiceGenome g2 = new DiceGenome(DiceGenomeTest.TEST3 /* 1 & 2 flipped */);
		assertTrue("equivalent", g1.equivalent(g2));
	}
	...
	public void notEquivalent() throws Exception {
		DiceGenome g1 = new DiceGenome(DiceGenomeTest.NORMAL);
		DiceGenome g2 = new DiceGenome(DiceGenomeTest.TEST1 /* 11 & 13 flipped */);
		assertFalse("not equivalent", g1.equivalent(g2));
	}

	@Test
	public void setSanityCheck() throws Exception {
		Set<Integer> oneOfThese = new HashSet<Integer>(Arrays.asList(1, 2, 3)), thingsIsNotLike = new HashSet<Integer>(Arrays.asList(3, 2, 1)), theOther = new HashSet<Integer>(
				Arrays.asList(3, 2, 4));
