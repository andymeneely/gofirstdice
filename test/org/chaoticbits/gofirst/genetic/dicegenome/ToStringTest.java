...
public class ToStringTest {
	...
	public void sortedToString() throws Exception {
		...
		DiceGenome genome = new DiceGenome(null, DiceGenomeTest.TEST3);
		String expectedToString = new DiceGenome(null, DiceGenomeTest.NORMAL).toString();
	...
	public void sortedToStringNoChange() throws Exception {
		// 1 and 2 are flipped, but are in the same die
		DiceGenome genome = new DiceGenome(null, DiceGenomeTest.TEST1);
